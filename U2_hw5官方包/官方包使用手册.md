...
class PersonRequest extends Request {
    ...
    **/
    ...
    public String toString() {
        return String.format("%d-WEI-%d-FROM-%s-TO-%s-BY-%d", this.personId, this.weight, this.fromFloor, this.toFloor, this.elevatorId);
    }
    ...
    @Override
    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.fromFloor, this.toFloor, this.personId, this.weight, this.elevatorId});
    }
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            ...
            return req.fromFloor.equals(fromFloor) && req.toFloor.equals(toFloor) && req.personId == this.personId && req.weight == this.weight && req.elevatorId == this.elevatorId;
        }
    }
}
```
...
输入：
```shell
[1.0]698-WEI-80-FROM-F1-TO-F4-BY-6
[1.0]841-WEI-80-FROM-F3-TO-F4-BY-4
[1.0]819-WEI-80-FROM-F1-TO-F4-BY-5
[1.0]248-WEI-80-FROM-F1-TO-B4-BY-4
[1.0]575-WEI-80-FROM-B1-TO-F6-BY-6
[1.0]434-WEI-80-FROM-F4-TO-F7-BY-6
[1.0]915-WEI-80-FROM-B2-TO-B1-BY-1
[1.0]915-WEI-80-FROM-F7-TO-F6-BY-2
```

输出：
* stdout
```shell
698-WEI-80-FROM-F1-TO-F4-BY-6
841-WEI-80-FROM-F3-TO-F4-BY-4
819-WEI-80-FROM-F1-TO-F4-BY-5
248-WEI-80-FROM-F1-TO-B4-BY-4
575-WEI-80-FROM-B1-TO-F6-BY-6
434-WEI-80-FROM-F4-TO-F7-BY-6
915-WEI-80-FROM-B2-TO-B1-BY-1
```

* stderr
```shell
com.oocourse.elevator1.DuplicatedIdException: Person request parse failed! - "915-WEI-10-FROM-F7-TO-F6-BY-2"
